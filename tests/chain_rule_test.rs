...
mod tests {
    ...
    fn test_chain_rule_with_child() {
        ...
        // Set up parent rule
        parent_rule
            .set_eval_fn(|context| Ok(context.get_bool("parent_should_execute").unwrap_or(true)));
        ...
        // Set up child rule
        child_rule
            .set_eval_fn(|context| Ok(context.get_bool("child_should_execute").unwrap_or(true)));
